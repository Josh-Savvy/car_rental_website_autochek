...
const ExploreCarsNav = () => {
	...
	return (
		<motion.div
			...
			<div className="bg-white shadow-lg flex flex-row gap-10 md:gap-0 flex-wrap lg:flex-nowrap justify-between items-center mx-6 sm:mx-auto p-4 px-20 md:p-6 rounded-lg sm:max-w-[75dvw] relative">
